            ...
            <ul class="sidebar-links" id="simple-bar">
               ...
               <li class="sidebar-list">
                ...
                <li class="sidebar-list topbar-items">
                  <a class="sidebar-link " href="{{url('/profile')}}"><i data-feather="user"></i><span>Profile</span></a>
               </li>
               <li class="sidebar-list topbar-items">
                  <a class="sidebar-link " href="{{url('/change_password')}}"><i data-feather="settings"></i><span>Change Password</span></a>
               </li>
